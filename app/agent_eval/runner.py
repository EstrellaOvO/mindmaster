...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Compare MindMaster multi-agent runtime with a one-call single-agent baseline.")
...
def print_report(report: dict, output_path: Path) -> None:
    ...
    print("MindMaster Multi-Agent vs Single-Agent Evaluation")
