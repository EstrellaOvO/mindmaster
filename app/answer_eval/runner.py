...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Evaluate MindMaster answer quality with an independent LLM judge.")
...
def print_report(report: dict, output_path: Path) -> None:
    ...
    print("MindMaster LLM-as-Judge Answer Quality Evaluation")
