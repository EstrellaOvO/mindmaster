...
class Settings(BaseSettings):
    ...
    ollama_model: str = "mindmaster-qwen2.5-7b-ft:latest"
    finetuned_model_name: str = "mindmaster-qwen2.5-7b-ft:latest"
    finetuned_model_dir: str = "models/mindmaster-qwen2.5-7b-ft"
    finetuned_model_file: str = "mindmaster-qwen2.5-7b-ft-q4_k_m.gguf"
    ...
    database_url: str = "mysql+pymysql://mindmaster:mindmaster@127.0.0.1:3306/mindmaster?charset=utf8mb4"
    ...
    chroma_collection_name: str = "mindmaster_knowledge"
    ...
    answer_eval_dataset: str = "app/evaluation/mindmaster-response-eval.jsonl"
    ...
    excel_path: str = "data/mindmaster-risk-ledger.xlsx"
    ...
    alert_email_to: str = ""
    alert_email_subject_prefix: str = "[MindMaster 高风险预警]"
