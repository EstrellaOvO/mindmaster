...
DEFAULT_DATASET = ROOT / "app" / "risk_eval" / "mindmaster-risk-eval-100.jsonl"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Evaluate MindMaster LOW/MEDIUM/HIGH risk classification.")
...
def print_report(report: dict, output_path: Path) -> None:
    ...
    print("MindMaster Risk Evaluation")
