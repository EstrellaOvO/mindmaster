...
class ToolQueueWorker:
    ...
    def start(self) -> None:
        ...
        self.dispatcher = threading.Thread(target=self._loop, name="mindmaster-tool-dispatcher", daemon=True)
