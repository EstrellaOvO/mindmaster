...
description: Use when MindMaster answers student mental-health consultation or risk messages; provides baseline empathy, scope, and student-facing response rules.
---
